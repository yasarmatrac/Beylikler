...
public class Tower2 extends Construction{
	
	String imageFileName = "images/tower/towers.gif";
	Image image;
	ArrayList<Arrow> arrow = new ArrayList<Arrow>();
	
	public Tower2 (ArrayList<Military> military,int team ,int x , int y){
	...
	private void loadImage (){
		...
		try {
			image = ImageIO.read(imageFileUrl).getSubimage(46,610,192,285);
		} catch (IOException e) {
